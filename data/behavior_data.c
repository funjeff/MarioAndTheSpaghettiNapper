...
const BehaviorScript bhvLuigiRope[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
	CALL_NATIVE(bhv_luigi_rope_init),
	BEGIN_LOOP(),
        CALL_NATIVE(bhv_luigi_rope_loop),
    END_LOOP(),
};

const BehaviorScript bhvLuigiableBomb[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
	BEGIN_LOOP(),
...
const BehaviorScript bhvPenny[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    //SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
	BEGIN_LOOP(),
        CALL_NATIVE(bhv_penny_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvNightmareChunk[] = {
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
	BEGIN_LOOP(),
        CALL_NATIVE(bhv_nightmare_chunk_loop),
    END_LOOP(),
};

const BehaviorScript bhvBigNightmareChunk[] = {
	BEGIN(OBJ_LIST_LEVEL),
	OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
	SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
	CALL_NATIVE(bhv_big_nightmare_chunk_init),
	BEGIN_LOOP(),
...
const BehaviorScript bhvMassif[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oBobombBuddyRole, 0),
	SET_INT(oBobombBuddyIsMassif, 1),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 220,100),
    SET_HOME(),
    CALL_NATIVE(bhv_bobomb_buddy_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
