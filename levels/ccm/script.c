...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		WARP_NODE(0x01, LEVEL_SSL, 0x01, 0x0A, WARP_CHECKPOINT),
		OBJECT(MODEL_CUTSCENE_BOWSER, 38, 199, -3079, -3, -176, -33, 0x00000000, bhvCutsceneProp),
		OBJECT(MODEL_CUTSCENE_LUIGI, 296, 220, -2683, 0, 167, 0, 0x00000000, bhvCutsceneProp),
		OBJECT(MODEL_CUTSCENE_TOAD, -416, 130, -2372, 0, 117, 0, (01 << 16), bhvCutsceneProp),
		OBJECT(MODEL_NONE, 50, 478, -2244, 0, 0, 0, (1 << 24), bhvCutsceneTrigger),
		OBJECT(MODEL_NONE, 34, 190, -2985, 0, 0, 0, (10 << 16), bhvWarpOneWay),
	...
	AREA(2, ccm_area_2),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01, LEVEL_JRB, 0x01, 0x0A, WARP_CHECKPOINT),
		OBJECT(MODEL_CUTSCENE_BOWSER, -6, 610, -3075, -3, -176, -33, 0x00010000, bhvBooCage),
		OBJECT(MODEL_TALKABLE_GOOMBA, -4603, 184, 236, 0, 4, 4, (0 << 24) | (44 << 16), bhvBobombBuddy),
		OBJECT(MODEL_TALKABLE_GOOMBA, -4270, 176, 533, 0, 4, 4, (0 << 24) | (43 << 16), bhvBobombBuddy),
		OBJECT(MODEL_TALKABLE_GOOMBA, -4167, 171, -266, 0, 4, 4, (0 << 24) | (42 << 16), bhvBobombBuddy),
		OBJECT(MODEL_TALKABLE_GOOMBA, -607, 486, -1960, 0, 4, 4, (0 << 24) | (66 << 16), bhvBobombBuddy),
		...
		OBJECT(MODEL_DISGUISED_TOAD, -3757, 97, -143, -3, 17, -2, (41 << 16), bhvBobombBuddy),
		OBJECT(MODEL_NONE, 289, 257, 2925, 0, 0, 0, (10 << 16), bhvWarpOneWay),
		MARIO_POS(0x02, 0, 289, 333, 2921),
