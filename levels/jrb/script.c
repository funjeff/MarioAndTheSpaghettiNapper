...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_CUTSCENE_LUIGI, 253, -5395, 9020, 0, 0, 0, 0x00000000, bhvCutsceneProp),
		OBJECT(MODEL_NONE, -83, -5433, 9044, 0, 0, 0, 0x00000000, bhvCutsceneTrigger),
		OBJECT(MODEL_NONE, -41, -5665, 8475, 0, 0, 0, 0x000A0000, bhvWarp),
		MARIO_POS(0x01, 0, -41, -5505, 8475),
