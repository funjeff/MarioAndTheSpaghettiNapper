...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_CANDACE, -7171, 10, -329, 91, -4, 4, (0 << 24) | (89 << 16), bhvBobombBuddy),
		OBJECT(MODEL_BALJEET, -7006, 48, 188, 0, 4, 4, (0 << 24) | (97 << 16), bhvBobombBuddy),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -7458, 25, -1, 0, 0, 0, 0x00010000, bhvWarpPipe),
		OBJECT(MODEL_NONE, -9723, 89, -1, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -9723, 89, -1),
