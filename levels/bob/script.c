...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		WARP_NODE(0x13, LEVEL_BOB, 0x01, 0x14, WARP_CHECKPOINT),
		WARP_NODE(0x14, LEVEL_BOB, 0x01, 0x13, WARP_CHECKPOINT),
		WARP_NODE(0x15, LEVEL_BOB, 0x01, 0x0A, WARP_CHECKPOINT),
		WARP_NODE(0x16, LEVEL_BOB, 0x01, 0x15, WARP_CHECKPOINT),
		OBJECT(ARROW_PLATFORM, -13067, -824, 7171, 0, 0, 0, (200 << 24) | (1 << 8) | (67), bhvArrowPlatform),
		...
		OBJECT(MODEL_BIG_MASSIF, -1433, 512, -833, -4, -40, 5, (0 << 24) | (49 << 16), bhvMassif),
		OBJECT(MODEL_LIL_MASSIF, -1161, 512, -569, -4, -41, 5, (0 << 24) | (50 << 16), bhvMassif),
		...
		OBJECT(MODEL_NIGHTMARE_CHUNK, 2279, 5685, 9671, 0, 0, 0, (03 << 16), bhvNightmareChunk),
		OBJECT(MODEL_NIGHTMARE_CHUNK, 9703, -1832, 7347, 0, 0, 0, (1 << 24) | (9 << 16), bhvNightmareChunk),
		OBJECT(MODEL_NIGHTMARE_CHUNK, 11282, 6408, 7980, 0, 0, 0, 0x01120000, bhvNightmareChunk),
		OBJECT(MODEL_NIGHTMARE_CHUNK, -3318, 455, -13717, 0, 0, 0, 0x00160000, bhvNightmareChunk),
		OBJECT(MODEL_NONE, -13134, -1015, -12053, 0, 90, 0, 0x00130000, bhvWarp),
		OBJECT(MODEL_NONE, 352, -1015, -1004, -90, 0, 0, 0x00140000, bhvWarp),
		OBJECT(MODEL_WOODEN_SIGNPOST, -7955, 169, 7910, 0, 13, 0, (63 << 16), bhvMessagePanel),
		OBJECT(MODEL_NONE, 1839, 427, -295, 0, 0, 0, 0x00150000, bhvWarpOneWay),
		OBJECT(MODEL_NONE, -7992, 209, 8332, 0, -180, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, -180, -7992, 369, 8332),
