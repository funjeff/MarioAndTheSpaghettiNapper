...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(ARROW_PLATFORM, -13067, -1635, -11476, 0, 0, 0, (145 << 24) | (1 << 8) | (65), bhvArrowPlatform),
		OBJECT(ARROW_PLATFORM, 3455, 5475, -9634, 0, 0, 0, (100 << 24) | (0 << 8) | (8), bhvArrowPlatform),
		OBJECT(ARROW_PLATFORM, -13167, 171, 3414, 0, 0, 0, (130 << 24) | (2 << 8) | (34), bhvArrowPlatform),
		OBJECT(ARROW_PLATFORM, 3379, 2867, 3636, 0, 0, 0, (115 << 24) | (3 << 8) | (4), bhvArrowPlatform),
		OBJECT(MODEL_NIGHTMARE_CHUNK, 45, 706, -97, 0, 0, 0, 0x00000000, bhvBigNightmareChunk),
		OBJECT(MODEL_NIGHTMARE_CHUNK, 2424, 5478, 9671, 0, 0, 0, (03 << 16), bhvNightmareChunk),
		OBJECT(MODEL_NIGHTMARE_CHUNK, 1381, -2538, -11482, 0, 0, 0, (1 << 24) | (05 << 16), bhvNightmareChunk),
		OBJECT(MODEL_BOWSER_BOMB, 8532, 4441, -9923, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOMBABLE_DOOR, 10985, 4073, -9549, 0, 0, 0, (3 << 8), bhvBombableDoor),
		OBJECT(MODEL_NONE, 8071, 4668, -8860, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 8071, 4828, -8860),
