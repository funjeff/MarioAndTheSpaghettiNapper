...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(ARROW_PLATFORM, -13067, -596, 7171, 0, 0, 0, (200 << 24) | (1 << 8) | (67), bhvArrowPlatform),
		...
		OBJECT(MODEL_BIG_MASSIF, 324, 512, -1295, 0, 4, 4, (0 << 24) | (43 << 16), bhvMassif),
		OBJECT(MODEL_LIL_MASSIF, 787, 512, -1295, 0, 4, 4, (0 << 24) | (43 << 16), bhvMassif),
		...
		OBJECT(MODEL_NIGHTMARE_CHUNK, 9703, -1604, 7347, 0, 0, 0, (1 << 24) | (9 << 16), bhvNightmareChunk),
		OBJECT(MODEL_NIGHTMARE_CHUNK, 11282, 6408, 7832, 0, 0, 0, 0x00120000, bhvNightmareChunk),
		OBJECT(MODEL_NIGHTMARE_CHUNK, -3318, 229, -13717, 0, 0, 0, 0x00160000, bhvNightmareChunk),
