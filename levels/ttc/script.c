...
const LevelScript level_ttc_entry[] = {
	...
	AREA(1, ttc_area_1),
		...
		OBJECT(MODEL_BOWSER_BOMB, -14616, 714, 2517, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, -11125, 304, 1140, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, -7719, 304, -530, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, -6307, 1438, -95, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, -2230, 1438, -325, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, 5620, 1315, -95, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, 10489, 1323, -95, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, 16226, 1274, 3311, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, 17469, 1428, -3631, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, 16555, 1296, -3837, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		OBJECT(MODEL_BOWSER_BOMB, 18528, 1222, 4331, 0, 0, 0, 0x00000000, bhvLuigiableBomb),
		...
		OBJECT(MODEL_BOMBABLE_DOOR, -6763, 1097, 17, 0, 0, 0, 0x00000000, bhvBombableDoor),
		...
		OBJECT(MODEL_BIG_BOMBABLE_DOOR, 19302, 1097, 17, 0, 0, 0, (4 << 24), bhvBigBombableDoor),
		OBJECT(MODEL_NONE, -14256, 200, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -14355, 1974, 0),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, 20795, 1035, 67, 0, 0, 0, (0 << 24) | (5 << 16), bhvWarpPipe),
