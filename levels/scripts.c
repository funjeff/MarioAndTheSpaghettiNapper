...
//    LOAD_MODEL_FROM_GEO(MODEL_BOBOMB_BUDDY,            bobomb_buddy_geo),
 ...
 //   LOAD_MODEL_FROM_GEO(MODEL_HEART,                   heart_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_NIGHTMARE_CHUNK,         nightmare_chunk_geo),
	LOAD_MODEL_FROM_GEO(MODEL_CASTLE_GROUNDS_WARP_PIPE,warp_pipe_geo),
	LOAD_MODEL_FROM_GEO(ARROW_PLATFORM,                arrow_platform_geo),
	LOAD_MODEL_FROM_GEO(MODEL_MARIO_PUPPET,            mario_puppet_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_SPAGHETTI,               spaghetti_geo),
	LOAD_MODEL_FROM_GEO(MODEL_CASTLE_BREAKABLE_WALL,   castle_breakable_wall_geo),
	LOAD_MODEL_FROM_GEO(MODEL_BUP_CUBE,                bup_cube_geo),
	LOAD_MODEL_FROM_GEO(MODEL_TOAD_STATUE,             toad_statue_geo),
	LOAD_MODEL_FROM_GEO(MODEL_KING_TOAD,               king_toad_geo),
	LOAD_MODEL_FROM_GEO(MODEL_GOOMBA_DOOR,             goomba_door_geo),
	LOAD_MODEL_FROM_GEO(MODEL_ANOTHER_DOOR,            another_door_geo),
