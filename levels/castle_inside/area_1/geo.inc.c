...
const GeoLayout castle_inside_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 90, 0, 0, castle_inside_dl__005_geometry_mesh_layer_5),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, castle_inside_dl__006_geometry_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 0, 1, 0, 90, 0, 0, castle_inside_dl__007_geometry_mesh_layer_5),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -1829, 3727, -1076, 0, 0, 90, castle_inside_dl_bup_008_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1620, 3743, -1076, castle_inside_dl_bup_009_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1817, 3523, -1076, castle_inside_dl_bup_010_mesh_layer_1),
