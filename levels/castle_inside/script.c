...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(0x26, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x27, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_CASTLE_DOOR_1_STAR, -1132, 611, -1264, 0, 176, 0, 0x00260000, bhvDoorWarp),
		OBJECT(MODEL_TALKABLE_LUIGI, -2593, 87, -380, 0, 0, 0, (65 << 16), bhvBobombBuddy),
		OBJECT(MODEL_NONE, 306, -309, -4504, 0, 0, 0, 0x00200000, bhvWarpOneWay),
		OBJECT(MODEL_NONE, -5054, 391, -647, 0, 0, 0, 0x00230000, bhvWarpOneWay),
		...
		OBJECT(MODEL_NONE, -3684, 347, -1145, 0, -97, 0, (68 << 16), bhvSignOnWall),
		...
		OBJECT(MODEL_NONE, -278, 42, -2007, 0, -173, 0, (70 << 16), bhvSignOnWall),
	...
	AREA(2, castle_inside_area_2),
		...
		WARP_NODE(0x23, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x25, LEVEL_DDD, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x26, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_CHECKPOINT),
