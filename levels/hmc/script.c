...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, -216, 492, 2191, 0, -174, 0, (1 << 16), bhvEndTrigger),
		OBJECT(MODEL_CUTSCENE_TOAD, 264, 155, 2384, 0, -174, 0, (69 << 16), bhvToadGoomba),
		OBJECT(MODEL_NONE, -53, 157, 1049, 0, 0, 0, (10 << 16), bhvWarpOneWay),
