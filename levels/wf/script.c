...
const LevelScript level_wf_entry[] = {
	...
	AREA(3, wf_area_3),
		...
		OBJECT(MODEL_EARTHWAKE_LEFT_FOOT, 75, -2505, 9518, 0, 95, 0, (1 << 16), bhvEarthwakeBlock),
		OBJECT(MODEL_EARTHWAKE_RIGHT_FOOT, -1385, -2505, 9636, 0, 95, 0, (1 << 16), bhvEarthwakeBlock),
		OBJECT(MODEL_EARTHWAKE_HEAD, -544, 3368, 9603, 0, -142, 0, (1 << 16) | (3 << 8), bhvEarthwakeBlock),
		...
		MARIO_POS(0x03, -174, -220, -203, 473),
	...
	AREA(2, wf_area_2),
		...
		OBJECT(ARROW_PLATFORM, -3176, 1487, 96, 0, 180, 0, (98 << 24) | (2 << 8) | (9), bhvArrowPlatform),
		...
		OBJECT(MODEL_EARTHWAKE_LEFT_SHOLDER, 957, 1458, 9397, 0, 95, 0, (7 << 24) | (1 << 8), bhvEarthwakeLeftShoulder),
		...
		OBJECT(MODEL_EARTHWAKE_RIGHT_SHOULDER, -1898, 1438, 9392, 0, 95, 0, (8 << 24) | (2 << 8), bhvEarthwakeRightShoulder),
		...
		OBJECT(MODEL_EARTHWAKE_LEFT_FOOT, 78, -2541, 9559, 0, 95, 0, 0x00000000, bhvEarthwakeBlock),
		OBJECT(MODEL_EARTHWAKE_RIGHT_FOOT, -1402, -2541, 9678, 0, 95, 0, 0x00000000, bhvEarthwakeBlock),
		...
		OBJECT(MODEL_EARTHWAKE_HEAD, -544, 3368, 9603, 0, -170, 0, (0 << 24) | (3 << 8), bhvEarthwakeBlock),
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_EARTHWAKE_LEFT_SHOLDER, 1177, -5206, 9059, 0, 95, 0, 0x00000000, bhvCutsceneProp),
		...
		OBJECT(MODEL_EARTHWAKE_RIGHT_SHOULDER, -1678, -5227, 9055, 0, 95, 0, 0x00000000, bhvCutsceneProp),
		...
		OBJECT(MODEL_EARTHWAKE_LEFT_FOOT, 295, -8762, 9180, 0, 95, 0, 0x00000000, bhvCutsceneProp),
		...
		OBJECT(MODEL_EARTHWAKE_HEAD, -325, -3693, 9265, 0, 148, 0, 0x00000000, bhvCutsceneProp),
