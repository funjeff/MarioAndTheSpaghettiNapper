COURSE_ACTS(COURSE_BOB, _("   LUIGI'S DREAM"),
       _("DREAMY WAKEPORT")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _("   LUIGI'S DREAM"),
       _("DREAM'S DEEP")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
       _("RED COINS ON THE FLOATING ISLE"), _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL"))

COURSE_ACTS(COURSE_JRB, _("  BOWSER'S DREAM"),
       _("ATTACK OF THE GOOMBAS")    , _("CAN THE EEL COME OUT TO PLAY?") , _("TREASURE OF THE OCEAN CAVE"),
       _("RED COINS ON THE SHIP AFLOAT")  , _("BLAST TO THE STONE PILLAR")     , _("THROUGH THE JET STREAM"))

COURSE_ACTS(COURSE_CCM, _("   BOWSER'S CASTLE"),
       _("ENTER BOWSER'S DREAM")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
       _("FROSTY SLIDE FOR 8 RED COINS")  , _("SNOWMAN'S LOST HIS HEAD")       , _("WALL KICKS WILL WORK"))

COURSE_ACTS(COURSE_BBH, _("   TOAD'S DREAM"),
       _("A FAMILIAR ROOM")            , _("RIDE BIG BOO'S MERRY-GO-ROUND") , _("SECRET OF THE HAUNTED BOOKS"),
       _("SEEK THE 8 RED COINS")          , _("BIG BOO'S BALCONY")             , _("EYE TO EYE IN THE SECRET ROOM"))

COURSE_ACTS(COURSE_HMC, _("  BOWSERS CASTLE"),
       _("THE FINAL SHOWDOWN")  , _("ELEVATE FOR 8 RED COINS")       , _("METAL-HEAD MARIO CAN MOVE!"),
...
COURSE_ACTS(COURSE_SSL, _("   TOAD'S DREAM"),
       _("TOAD'S KINGDOM") , _("SHINING ATOP THE PYRAMID")      , _("INSIDE THE ANCIENT PYRAMID"),
       _("STAND TALL ON THE FOUR PILLARS"), _("FREE FLYING FOR 8 RED COINS")   , _("PYRAMID PUZZLE"))

COURSE_ACTS(COURSE_DDD, _("   TOAD'S DREAM"),
       _("TOAD'S TRESURE")            , _("CHESTS IN THE CURRENT")         , _("POLE-JUMPING FOR RED COINS"),
...
COURSE_ACTS(COURSE_TTM, _("   TOAD'S DREAM"),
       _("?????????????")            , _("MYSTERY OF THE MONKEY CAGE")    , _("SCARY 'SHROOMS, RED COINS"),
...
COURSE_ACTS(COURSE_TTC, _("   BOWSER'S DREAM"),
       _("BOWSER'S DOOR ARMY")            , _("THE PIT AND THE PENDULUMS")     , _("GET A HAND"),
...
SECRET_STAR(COURSE_BITS, _("   BOWSER'S DREAM"))
SECRET_STAR(COURSE_PSS, _("   TOAD'S TROLLY SLIDE"))
...
CASTLE_SECRET_STARS(_("   NUMBER OF BITCHES"))
