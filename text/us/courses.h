COURSE_ACTS(COURSE_BOB, _("   LUIGIS DREAM"),
...
COURSE_ACTS(COURSE_WF, _("   LUIGIS DREAM"),
       _("DREAMS DEEP")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
       _("RED COINS ON THE FLOATING ISLE"), _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL"))

COURSE_ACTS(COURSE_JRB, _("  BOWSERS DREAM"),
...
COURSE_ACTS(COURSE_CCM, _("   BOWSERS CASTLE"),
       _("ENTER BOWSERS DREAM")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
...
COURSE_ACTS(COURSE_SSL, _("   TOADS DREAM"),
       _("TOADS KINGDOM") , _("SHINING ATOP THE PYRAMID")      , _("INSIDE THE ANCIENT PYRAMID"),
       _("STAND TALL ON THE FOUR PILLARS"), _("FREE FLYING FOR 8 RED COINS")   , _("PYRAMID PUZZLE"))

COURSE_ACTS(COURSE_DDD, _("   TOADS DREAM"),
       _("TOADS TRESURE")            , _("CHESTS IN THE CURRENT")         , _("POLE-JUMPING FOR RED COINS"),
...
COURSE_ACTS(COURSE_TTM, _("   TOADS DREAM"),
...
COURSE_ACTS(COURSE_TTC, _("   BOWSERS DREAM"),
       _("BOWSERS DOOR ARMY")            , _("THE PIT AND THE PENDULUMS")     , _("GET A HAND"),
...
SECRET_STAR(COURSE_PSS, _("   TOADS TROLLY SLIDE"))
